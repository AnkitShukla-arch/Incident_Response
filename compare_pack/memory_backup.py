...
def export_memory() -> dict:
    ...
    with connect_db() as conn:
        rows = conn.execute(
            ...
            "severity, status, created_at, postmortem_doc FROM incidents ORDER BY id"
        ).fetchall()
...
def import_memory(data: dict) -> dict:
    ...
    with connect_db() as conn:
        for inc in incidents:
            ...
            postmortem_doc = inc.get("postmortem_doc")
            ...
            row = conn.execute(
                ...
                ON CONFLICT (id) DO UPDATE SET
                    ...
                    postmortem_doc = EXCLUDED.postmortem_doc
